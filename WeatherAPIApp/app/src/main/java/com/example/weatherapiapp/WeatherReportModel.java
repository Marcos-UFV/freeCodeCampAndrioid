...
public class WeatherReportModel {
    ...
    public WeatherReportModel(int id, String weather_state_name, String weather_state_abbr, String wind_direction_compass, String created, String applicable_date, float min_temp, float max_temp, float the_temp, float wind_speed, float wind_direction, int ait_pressure, int humidity, float visibility, int predictability) {
        ...
        this.ait_pressure = ait_pressure;
    ...
    public String toString() {
        return String.format("%s Date: %s min_temp= %.2f max_temp= %.2f the_temp= %.2f",
                weather_state_name,applicable_date,min_temp,max_temp,the_temp);
...
//                '}';
    ...
    public int getAit_pressure() {
        return ait_pressure;
    }

    public void setAit_pressure(int ait_pressure) {
        this.ait_pressure = ait_pressure;
    }
